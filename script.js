...
const experiences = [
  { company:"Tanda", role:"产品经理 · B 端人力 SaaS", period:"2026.06 - 2026.07", summary:"围绕智能排班、移动考勤与薪资核算，参与从用户调研、竞品分析到功能上线的完整产品迭代。", details:["访谈 9 位企业 HR 与一线管理者","输出 PRD、7 页高保真原型及操作手册","功能上线后产品转化率提升 6%"], color:"purple" },
  { company:"苏宁易购（总部）", role:"产品实习生 · 采购数字化", period:"2025.09 - 2025.12", summary:"深入采购、财务等 5 个部门，设计供应商信息、采购计划、申请发起与绩效评价等核心模块。", details:["独立完成 15+ 页高保真原型","推动供应商与采购数据全链路可追溯","系统上线后供应商准入周期缩短 40%"], color:"mint" },
  { company:"水木莘森景观设计", role:"设计实习生 · 空间与体验", period:"2024.01 - 2024.03", summary:"从场地、需求与可持续原则出发，把规划构想转化为可实施的空间方案，并衔接施工落地。", details:["独立绘制平面、剖面与立面图","兼顾功能、美观与生态友好","积累从概念到执行的完整设计视角"], color:"pink" }
];
let messageIndex = 0;
